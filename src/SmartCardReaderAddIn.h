...
#ifndef SMARTCARDREADERADDIN_H
#define SMARTCARDREADERADDIN_H

#include "Component.h"

class SmartCardReaderAddIn final : public Component {
public:
    const char *Version = u8"1.0.0";

    SmartCardReaderAddIn();
